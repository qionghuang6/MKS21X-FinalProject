...
public class PokemonRandomizer{
  ...
  //grass Moves
  static Move razorLeaf = new Move("Razor Leaf", "Grass",15,5,8);
  static Move vineWhip = new Move("Whirlpool", "Grass",10,1,15);
  ...
  static List<Move> grassMoves = new ArrayList(Arrays.asList(razorLeaf,vineWhip,tailWhip,growl));
